#!/usr/bin/env python3
#sudo apt install python3-netifaces -y >/dev/null 2>&1
...
try:
    ...
    print("\033[91m[ERROR]\033[0m netifaces no está instalado.")
    print("Instálalo con:")
    print("  sudo apt install python3-netifaces python3-scapy -y >/dev/null  ")
    sys.exit(1)
...
try:
    ...
    print("\033[91m[ERROR]\033[0m scapy no está instalado.")
    print("Instálalo con:")
    print("  sudo apt install python3-scapy -y")
    sys.exit(1)

# --- resto del script ---
print("\033[92m[MÓDULOS OK]\033[0m")


#sudo apt install python3-scapy -y >/dev/null 2>&1
import ipaddress
import logging
import netifaces
...
#   --------------------------------------------------------------------------------------------------------------------
#   ....................................
# Usage: Conectarse a la red wifi con la tarjeta alfa
# Ya al tener la red conectada ejecuta: 
# sudo muertewifi -i WlanAlfa.    con la red de la tarjeta alfa conectada a wifi
# 
#   --------------------------------------------------------------------------------------------------------------------
