...
const defaultLabTtlMinutes = 120;
const windowsProxmoxTemplateVmid = 107;
...
export const labs = [
  {
    ...
    category: "linux",
    platform: "Linux",
    defaultTtlMinutes: defaultLabTtlMinutes,
    enabled: true,
  ...
  },
  {
    ...
    category: "windows",
    platform: "Windows",
    proxmoxTemplateVmid: windowsProxmoxTemplateVmid,
    defaultTtlMinutes: defaultLabTtlMinutes,
    enabled: true,
